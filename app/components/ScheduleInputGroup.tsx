                ...
                <div className="flex-1">
                    ...
                    >
                        ...
                        <SelectContent className="bg-slate-900 border-slate-700 text-white rounded-xl">
                            {AVAILABLE_VILLAGES.filter(
                                (v) => !addedVillages.includes(v)
                            ).map((v) => (
                                <SelectItem
                                    key={v}
                                    value={v}
                        ...
                        >
                            ...
                            {selectedVillage === v && (
                                <button
                                    ...
                                    className="ml-1 hover:scale-110 transition-transform focus:outline-none focus:ring-2 focus:ring-red-500/50 rounded"
                    ...
                    <div className="space-y-4">
                        <div className="flex gap-3">
                            ...
                            {selectedVillage && (
                                <button
                                    type="button"
                                    onClick={() =>
                                        handleRemoveVillage(selectedVillage)
                                    }
                        ...
                        {selectedVillage ? (
                            <div className="space-y-3 animate-in fade-in slide-in-from-top-4 duration-300">
                                ...
                                <textarea
                                    value={
                                        schedules[selectedVillage]?.join(
                                            '\n'
                                        ) || ''
                                    }
                            ...
                            <div className="py-12 text-center border-2 border-dashed border-slate-800/50 rounded-3xl bg-slate-900/10">
                                <p className="text-slate-600 text-[10px] uppercase tracking-[0.2em]">
                                    Selecione uma aldeia acima para editar os
                                    horários
                                </p>
                            </div>
                        )}
