...
export function meta({ loaderData }: Route.MetaArgs) {
    ...
    return [
        { title: `Aviança Água de Víbora ${year}` },
        {
            name: 'description',
            content: `Consulte o horário de rega anual da água de Víbora para ${year}. Exporte para PDF, Excel ou adicione ao Google Calendar.`,
        },
        {
            name: 'keywords',
            content: `água víbora ${year}, horário rega, calendário rega, abadim`,
        },
    ]
}
