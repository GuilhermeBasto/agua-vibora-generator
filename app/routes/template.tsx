        ...
        <div className="p-6 sm:p-10 space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <label className="text-[10px] font-bold text-cyan-500 uppercase tracking-[0.2em] ml-1">
                Visualização Direta
              </label>
              <Link
            ...
            <div className="space-y-4">
              <label className="text-[10px] font-bold text-amber-500 uppercase tracking-[0.2em] ml-1">
                Administração
              </label>
              <Link
